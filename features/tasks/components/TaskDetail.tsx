...
export const TaskDetail: React.FC<TaskDetailProps> = ({ task }) => {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 py-4 flex items-center justify-between bg-white">
         <div className="flex items-center gap-3">
             ...
             <div className="flex items-center gap-2 bg-slate-50 pl-1 pr-3 py-1 rounded-full border border-slate-200 cursor-pointer hover:border-indigo-300 transition-colors">
                 ...
                 <span className="text-sm font-semibold text-slate-700 truncate max-w-[140px]">{task.assigneeName || 'Unassigned'}</span>
             </div>
         </div>

         <button className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-slate-600 bg-white border border-slate-200 rounded-md hover:bg-slate-50 transition-colors">
            Reassign
      ...
      {/* Info Bar */}
      <div className="bg-slate-50/80 border-y border-slate-100 px-6 py-3 grid grid-cols-3 gap-y-2 gap-x-4 text-xs">
