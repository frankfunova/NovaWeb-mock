    ...
    <div className="w-full pr-6">
        ...
        <div className="flex items-center gap-2 text-sm relative flex-wrap">
            <div className="flex items-center gap-1">
                ...
                >
                    <span className="text-slate-700 font-medium truncate max-w-[140px] group-hover:text-indigo-600" title={review.guestName}>
                        {review.guestName || 'Guest'}
                    </span>
                    <button 
                        className={`p-0.5 rounded-full group-hover:bg-slate-100 text-slate-400 group-hover:text-slate-600 transition-colors ${isGuestProfileOpen ? 'bg-slate-100 text-slate-600' : ''}`}
                    >
                ...
                <div className="absolute top-full left-0 mt-2 w-[280px] bg-white rounded-xl shadow-xl border border-slate-200 z-50 p-4 animate-in fade-in zoom-in-95 duration-200 text-left">
                    ...
                    <div className="space-y-3">
                        <div>
                            ...
                            <div className="text-sm font-medium text-slate-800 truncate" title={review.guestEmail || 'guest@example.com'}>
                                {review.guestEmail || 'guest@example.com'}
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <a href="#" className="text-xs font-medium text-indigo-600 hover:underline truncate block">
                                airbnb.com/users/733300000000000302
                            </a>
                        </div>
                    </div>
                </div>
